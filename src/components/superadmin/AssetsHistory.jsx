...
import { useGetAssetDetailQuery } from "../../redux/features/assest/assestApi";
...
const AssetHistory = () => {
  ...
  const maturityData = {
    current: data.asset_Maturity.current_spend
      ? data.asset_Maturity.current_spend
      : 0,
    max: data.asset_Maturity.max_spend ? data.asset_Maturity.max_spend : 0,
    percentage: data.asset_Maturity.percentage
      ? data.asset_Maturity.percentage
      : 0,
  };
    ...
    <div className="p-6">
      ...
      <div className="">
        <div className="space-y-6 flex  gap-6">
          ...
          <div className="rounded-lg border bg-white p-6 w-full">
            ...
            <div className="grid gap-4">
              {Object.entries(assetDetails).map(([key, value]) => (
                <div
                  key={key}
                  className="grid even:bg-[#F0F0F0] p-1 grid-cols-2 gap-4 border-b pb-2"
                >
          ...
          {/* Asset Maturity */}
          <div className="rounded-lg border bg-white p-6 w-full ">
            <h2 className="mb-4 text-lg font-semibold flex space-x-2 items-center">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
