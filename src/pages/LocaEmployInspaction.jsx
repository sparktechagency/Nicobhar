...
const LocaEmployInspaction = () => {
    ...
    const handleNavigate = (record) => {
        ...
        if (activeTabKey === 'New Sheets') {
            return navigate(`/location-employee/create-inspection/${record?.id}`)
        }
        else if (activeTabKey === 'Open Sheets') {
            return navigate(`/location-employee/open-sheet-details/${record?.id}`)
        } else if (activeTabKey === 'Past Sheets') {
            return navigate(`/location-employee/past-sheet-details/${record?.id}`)
        }
    }
