...
const navigate = useNavigate()
    ...
    return (
        <div className="tickets-page relative p-4">
            ...
            <LocationInspactionModal  isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} ticket={selectedTicket} />
        </div>
    );
};

export default LocaEmployInspaction;
