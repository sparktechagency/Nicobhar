...
const Statistics = () => (
  <div className="space-y-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <DonutChart title="Ticket Status" staticsLink="/location-employee/tickets-activity" data={ticketStatusData} />
      <DonutChart title="Inspections" staticsLink="/location-employee/inspections-activity" data={inspectionsData} />
      <DonutChart title="Job Card Progress" staticsLink="/location-employee/jobcards-overview" data={jobCardProgressData} />
