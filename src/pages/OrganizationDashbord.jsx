...
export default function MetricsDashboard() {
  ...
  useEffect(() => {
    if (repData) {
      console.log("Received report data:", repData);
      showBModal();
    }
  ...
  const outOfAssetDetailsData =
    data?.data?.["out_of_order_assets    "]?.asset_data;
    ...
    >
      <div>
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => {
              showModal("job"); // Pass the type directly to showModal
            }}
            className="text-[16px] font-bold rounded-lg text-[#ffff] mb-3 py-2 bg-[#ED1C24] px-8"
          >
            + Create Report
          </button>
          <Modal
          ...
          <Modal
            ...
            title={
              <div className="w-full border-b flex flex-row justify-between items-center pb-4">
                <div>
                  <p>Report ID: #{repData?.data?.data?.report_id}</p>
                </div>
            ...
            <div className="py-6">
              <div className="flex flex-col space-y-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  Total asset of your organization
                </p>

                {/* dynamic data by server-site */}
                <div className="text-2xl font-bold">
                  {dashboardData?.total_asset}
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="py-6 w-full">
              <div className="flex flex-col space-y-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  Total tickets of your organization
                </p>

                {/* dynamic data by server-site */}
                <div className="text-2xl font-bold">
                  {dashboardData?.total_ticket}
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card>
            <div className="py-6">
              <div className="flex flex-col space-y-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  Total job cards of your organization
                </p>

                {/* dynamic data by server-site */}
                <div className="text-2xl font-bold">
                  {dashboardData?.total_job_card}
                </div>
              </div>
            </div>
          </Card>
              ...
              <div className="flex flex-col space-y-2 text-center">
                <div className="text-center">
                  <div className="bg-[#FFF0F0] px-2 py-2 text-white  rounded-full w-fit mx-auto mb-2">
                    ...
                    >
                      <path
                        d="M23 2.55556C23 1.14617 21.8538 0 20.4444 0H2.55556C1.14617 0 0 1.14617 0 2.55556V20.4444C0 21.8538 1.14617 23 2.55556 23H20.4444C21.8538 23 23 21.8538 23 20.4444V2.55556ZM2.55556 20.4444V2.55556H20.4444L20.447 20.4444H2.55556Z"
                        fill="#ED1C24"
                      />
                      <path
                        d="M5.11108 5.11133H7.66408V7.66688H5.11108V5.11133ZM10.2222 5.11133H17.8889V7.66688H10.2222V5.11133ZM5.11108 10.2224H7.66408V12.778H5.11108V10.2224ZM10.2222 10.2224H17.8889V12.778H10.2222V10.2224ZM5.11108 15.3336H7.66408V17.8891H5.11108V15.3336ZM10.2222 15.3336H17.8889V17.8891H10.2222V15.3336Z"
                        fill="#ED1C24"
                      />
                    </svg>
                  </div>
                ...
                <p className="text-xs text-muted-foreground">
                  Total inspection sheets of your organization
                </p>

                {/* dynamic data by server-site */}
                <div className="text-2xl font-bold">
                  {dashboardData?.total_inspection_sheet}
                </div>
              </div>
            </div>
          </Card>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div className="py-10 grid grid-cols-2">
            ...
            <div
              ...
              className="w-full h-[450px] overflow-y-auto"
            >
          ...
          {/* Warranty Details */}
          <div className="grid grid-cols-2  bg-gray-200 py-10 h-[500px]">
          ...
          {/* Ticket Status */}
          <div className="grid grid-cols-2 bg-gray-200 py-10">
            <div
              className="w-full"
              style={{ display: "flex", gap: "20px", alignItems: "center" }}
            >
