        ...
        <div className="tickets-page">
            <div className="header">
                <div className="search-section">
                    <Input style={{height:'44px'}} prefix={<SearchOutlined />} placeholder="Search tickets..." className="search-input" />
                </div>

                <Button onClick={handleticketacvity} type="primary" size="large" className="text-lg font-semibold">
                    Tickets Acvity 
                </Button>
                <Select style={{height:'44px',marginLeft:'16px'}} defaultValue="Dhaka" className="location-select">
            ...
            <OrganizationTicketModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} ticket={selectedTicket} />
        </div>
    )
}
