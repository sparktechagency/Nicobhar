...
import OrgeditProfiel from "../components/organization/OrgeditProfiel";
...
export default function OrgserviceProvider() {
  ...
  return (
    <div className="space-y-6">
      ...
      <OrgProfile isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} ticket={selectedItem} />
      <OrgeditProfiel isOpen={iseditDetailsModalopen} onClose={() => setiseditdetsilsModalopen(false)} ticket={selectedItem} />
