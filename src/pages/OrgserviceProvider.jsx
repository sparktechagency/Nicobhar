  ...
  return (
    <div className="space-y-6">
          ...
          {!isLoading && (
            <table className="w-full bg-white">
              ...
              <tbody className="divide-y">
                {data?.data?.data?.map((provider, index) => (
                  <tr key={index} className="hover:bg-gray-50 bg-white  ">
                    ...
                    <td className="px-6 py-4 text-sm">
                      {activeTab === "organization"
                        ? provider.technicians_count +
                          provider.support_agents_count +
                          provider.location_employees_count
                        : provider?.organization?.name}
                    </td>
                    <td className="px-6 py-4 text-sm">{provider?.address}</td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <button
                          type="button"
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            setEditableTicket(provider);
                            setModSituation("edit");
                            handleEdit(provider);
                          }}
                          className="text-gray-400 hover:text-gray-600"
                        >
      ...
      <OrganizationModal
        ...
        onClose={() => setiseditdetsilsModalopen(false)}
        type={modSituation}
        ticket={selectedItem}
