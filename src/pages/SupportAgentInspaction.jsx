...
const SupportAgentInspaction = () => {
    ...
    console.log(allInspectionSheet)
    // console.log(detailsInspectionSheet)
    ...
    function formatDateTime(dateString) {
        ...
        // Format time: hh:mm am/pm (remove leading 0 and lowercase)
        ...
        const [hourPart, minutePart, period] = formattedTime.match(/(\d+):(\d+)\s(AM|PM)/i).slice(1);
        const finalTime = `${Number(hourPart)}:${minutePart} ${period.toLowerCase()}`;
    ...
    const createdAt = "2025-03-13T04:31:24.000000Z";

    const result = formatDateTime(createdAt);
    console.log(result, 'datessssssss');
