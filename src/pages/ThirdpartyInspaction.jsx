...
const ThirdpartyInspaction = () => {
    ...
    const handleNavigate = (record) => {
        ...
        if (activeTabKey === 'New Sheets') {
            return navigate(`/thirdparty/create-inspection/${record?.id}`)
        }
        else if (activeTabKey === 'Open Sheets') {
            return navigate(`/thirdparty/open-sheet-details/${record?.id}`)
        } else if (activeTabKey === 'Past Sheets') {
            return navigate(`/thirdparty/past-sheet-details/${record?.id}`)
        }
    }
