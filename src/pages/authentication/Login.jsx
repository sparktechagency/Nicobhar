    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-[600px] px-[70px] py-[50px] shadow-lg border-[2px] border-[#FEFEFE] ">
        <div className="text-center mb-8">
          ...
          <Text
            style={{ fontSize: "14px", color: "#5C5C5C", marginBottom: "8px" }}
            type="secondary"
          >
        ...
        >
          <Form.Item
            label={
              <p className="text-[#636363] text-[16px] font-medium">Email</p>
            }
            name="email"
            rules={[
          ...
          <Form.Item
            label={
              <p className="text-[#636363] text-[16px] font-medium">Password</p>
            }
            name="password"
            rules={[
          ...
          <Form.Item>
            <div className="flex items-center justify-between">
              <Checkbox style={{ color: "#636363", fontSize: "16px" }}>
                Remember Password
              </Checkbox>
              <Link
                to="/reset-password"
                className="text-[#1877F2] hover:text-[#1877F2] text-[16px] font-medium float-right"
              >
                Forgot Password?
              </Link>
            </div>
